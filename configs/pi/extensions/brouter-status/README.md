...
- Reads brouter response headers and shows the latest route plus runtime context window in the status area.
...
- `/brouter-context` — show the latest brouter runtime context/session accounting headers.
